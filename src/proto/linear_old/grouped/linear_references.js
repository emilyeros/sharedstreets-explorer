...
$root.BinnedData = (function() {

    /**
     * Properties of a BinnedData.
     * @exports IBinnedData
     * @interface IBinnedData
     * @property {Array.<number>|null} [binPosition] BinnedData binPosition
     * @property {Array.<number>|null} [binValue] BinnedData binValue
     */

    /**
     * Constructs a new BinnedData.
     * @exports BinnedData
     * @classdesc Represents a BinnedData.
     * @implements IBinnedData
     * @constructor
     * @param {IBinnedData=} [properties] Properties to set
     */
    function BinnedData(properties) {
        this.binPosition = [];
        this.binValue = [];
        if (properties)
            for (var keys = Object.keys(properties), i = 0; i < keys.length; ++i)
    ...
    /**
     * BinnedData binPosition.
     * @member {Array.<number>} binPosition
     * @memberof BinnedData
     * @instance
     */
    BinnedData.prototype.binPosition = $util.emptyArray;
     ...
     * @instance
     */
    BinnedData.prototype.binValue = $util.emptyArray;

    /**
     * Creates a new BinnedData instance using the specified properties.
     * @function create
     * @memberof BinnedData
     * @static
     * @param {IBinnedData=} [properties] Properties to set
     * @returns {BinnedData} BinnedData instance
     */
    BinnedData.create = function create(properties) {
        return new BinnedData(properties);
    };

    /**
     * Encodes the specified BinnedData message. Does not implicitly {@link BinnedData.verify|verify} messages.
     * @function encode
     * @memberof BinnedData
     * @static
     * @param {IBinnedData} message BinnedData message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    BinnedData.encode = function encode(message, writer) {
        if (!writer)
            writer = $Writer.create();
    ...
    /**
     * Encodes the specified BinnedData message, length delimited. Does not implicitly {@link BinnedData.verify|verify} messages.
     * @function encodeDelimited
     * @memberof BinnedData
     * @static
     * @param {IBinnedData} message BinnedData message or plain object to encode
     ...
     * @returns {$protobuf.Writer} Writer
     */
    BinnedData.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a BinnedData message from the specified reader or buffer.
     * @function decode
     * @memberof BinnedData
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {BinnedData} BinnedData
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    BinnedData.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.BinnedData();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
    ...
    /**
     * Decodes a BinnedData message from the specified reader or buffer, length delimited.
     * @function decodeDelimited
     * @memberof BinnedData
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    BinnedData.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
            reader = new $Reader(reader);
        return this.decode(reader, reader.uint32());
    };
     ...
     * @returns {string|null} `null` if valid, otherwise the reason why it is not
     */
    BinnedData.verify = function verify(message) {
        if (typeof message !== "object" || message === null)
            return "object expected";
    ...
    /**
     * Creates a BinnedData message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof BinnedData
     * @static
     * @param {Object.<string,*>} object Plain object
     * @returns {BinnedData} BinnedData
     */
    BinnedData.fromObject = function fromObject(object) {
        if (object instanceof $root.BinnedData)
            return object;
        var message = new $root.BinnedData();
        if (object.binPosition) {
            if (!Array.isArray(object.binPosition))
                throw TypeError(".BinnedData.binPosition: array expected");
            message.binPosition = [];
        ...
        if (object.binValue) {
            if (!Array.isArray(object.binValue))
                throw TypeError(".BinnedData.binValue: array expected");
            message.binValue = [];
    ...
    /**
     * Creates a plain object from a BinnedData message. Also converts values to other types if specified.
     * @function toObject
     * @memberof BinnedData
     * @static
     * @param {BinnedData} message BinnedData
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    BinnedData.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.arrays || options.defaults) {
    ...
    /**
     * Converts this BinnedData to JSON.
     * @function toJSON
     * @memberof BinnedData
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    BinnedData.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };
...
$root.SharedStreetsBinnedLinearReferences = (function() {
     ...
     * @property {Array.<string>|null} [dataType] SharedStreetsBinnedLinearReferences dataType
     * @property {Array.<IBinnedData>|null} [binnedData] SharedStreetsBinnedLinearReferences binnedData
     */
    ...
    /**
     * SharedStreetsBinnedLinearReferences dataType.
     * @member {Array.<string>} dataType
     * @memberof SharedStreetsBinnedLinearReferences
     * @instance
     */
    SharedStreetsBinnedLinearReferences.prototype.dataType = $util.emptyArray;

    /**
     * SharedStreetsBinnedLinearReferences binnedData.
     * @member {Array.<IBinnedData>} binnedData
     * @memberof SharedStreetsBinnedLinearReferences
     * @instance
     */
    SharedStreetsBinnedLinearReferences.prototype.binnedData = $util.emptyArray;
    ...
    SharedStreetsBinnedLinearReferences.encode = function encode(message, writer) {
        ...
        if (message.dataType != null && message.dataType.length)
            for (var i = 0; i < message.dataType.length; ++i)
                writer.uint32(/* id 4, wireType 2 =*/34).string(message.dataType[i]);
        if (message.binnedData != null && message.binnedData.length)
            for (var i = 0; i < message.binnedData.length; ++i)
                $root.BinnedData.encode(message.binnedData[i], writer.uint32(/* id 5, wireType 2 =*/42).fork()).ldelim();
        return writer;
    };
    ...
    SharedStreetsBinnedLinearReferences.decode = function decode(reader, length) {
        ...
        while (reader.pos < end) {
            ...
            case 4:
                ...
                break;
            case 5:
                if (!(message.binnedData && message.binnedData.length))
                    message.binnedData = [];
                message.binnedData.push($root.BinnedData.decode(reader, reader.uint32()));
                break;
            default:
                reader.skipType(tag & 7);
                break;
    ...
    SharedStreetsBinnedLinearReferences.verify = function verify(message) {
        ...
        if (message.binnedData != null && message.hasOwnProperty("binnedData")) {
            if (!Array.isArray(message.binnedData))
                return "binnedData: array expected";
            for (var i = 0; i < message.binnedData.length; ++i) {
                var error = $root.BinnedData.verify(message.binnedData[i]);
                if (error)
                    return "binnedData." + error;
            }
        }
        return null;
    };
    ...
    SharedStreetsBinnedLinearReferences.fromObject = function fromObject(object) {
        ...
        if (object.dataType) {
            if (!Array.isArray(object.dataType))
                throw TypeError(".SharedStreetsBinnedLinearReferences.dataType: array expected");
            message.dataType = [];
            for (var i = 0; i < object.dataType.length; ++i)
                message.dataType[i] = String(object.dataType[i]);
        }
        if (object.binnedData) {
            if (!Array.isArray(object.binnedData))
                throw TypeError(".SharedStreetsBinnedLinearReferences.binnedData: array expected");
            message.binnedData = [];
            for (var i = 0; i < object.binnedData.length; ++i) {
                if (typeof object.binnedData[i] !== "object")
                    throw TypeError(".SharedStreetsBinnedLinearReferences.binnedData: object expected");
                message.binnedData[i] = $root.BinnedData.fromObject(object.binnedData[i]);
            }
        }
        return message;
    };
    ...
    SharedStreetsBinnedLinearReferences.toObject = function toObject(message, options) {
        ...
        if (message.binnedData && message.binnedData.length) {
            object.binnedData = [];
            for (var j = 0; j < message.binnedData.length; ++j)
                object.binnedData[j] = $root.BinnedData.toObject(message.binnedData[j], options);
        }
        return object;
    };
