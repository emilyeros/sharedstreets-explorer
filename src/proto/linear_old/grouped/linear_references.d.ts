...
/** Represents a BinnedData. */
export class BinnedData implements IBinnedData {

    /**
     * Constructs a new BinnedData.
     * @param [properties] Properties to set
     */
    constructor(properties?: IBinnedData);
     ...
     * @param [properties] Properties to set
     * @returns BinnedData instance
     */
    public static create(properties?: IBinnedData): BinnedData;

    /**
     * Encodes the specified BinnedData message. Does not implicitly {@link BinnedData.verify|verify} messages.
     * @param message BinnedData message or plain object to encode
     * @param [writer] Writer to encode to
     * @returns Writer
     */
    public static encode(message: IBinnedData, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @returns Writer
     */
    public static encodeDelimited(message: IBinnedData, writer?: $protobuf.Writer): $protobuf.Writer;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): BinnedData;
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): BinnedData;
     ...
     * @returns BinnedData
     */
    public static fromObject(object: { [k: string]: any }): BinnedData;

    /**
     * Creates a plain object from a BinnedData message. Also converts values to other types if specified.
     * @param message BinnedData
     * @param [options] Conversion options
     * @returns Plain object
     */
    public static toObject(message: BinnedData, options?: $protobuf.IConversionOptions): { [k: string]: any };
